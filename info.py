...
START_MESSAGE = environ.get('START_MESSAGE', '<b>🥀𝗛𝗲𝘆{user}\n\n𝗠𝘆 𝗡𝗮𝗺𝗲 {bot},\n𝘐 𝗖𝗮𝗻 𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝗠𝗼𝘃𝗶𝗲𝘀,𝗝𝘂𝘀𝘁 𝗔𝗱𝗱 𝗠𝗲 𝗧𝗼 𝗬𝗼𝘂𝗿 𝗚𝗿𝗼𝘂𝗽 𝗔𝗻𝗱  𝗠𝗮𝗸𝗲 𝗠𝗲 𝗔𝗱𝗺𝗶𝗻....𝗧𝗵𝗲𝗻 𝗦𝗲𝗲 𝗠𝘆 𝗣𝗼𝘄𝗲𝗿𝘀⚡️⚡️⚡️\n\n©𝗠𝗮𝗶𝗻𝘁𝗮𝗶𝗻𝗲𝗱 𝗕𝘆 @CINEMACLUBLINKZ</b>')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>📂 𝗙𝗶𝗹𝗲 𝗡𝗮𝗺𝗲 </b> : <code>{file_name}</code>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", None)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>𝗛𝗲𝘆 </b>👋🏻 <b>{message.from_user.mention}</b>\n\n<b>🔖 𝗧𝗶𝘁𝗹𝗲 </b>: <b>{search}</b>\n<b>📫 𝗬𝗼𝘂𝗿 𝗙𝗶𝗹𝗲𝘀 𝗶𝘀 𝗥𝗲𝗮𝗱𝘆 𝗡𝗼𝘄</b>\n\n<b>♨️ 𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗕𝘆 </b>: <b>{message.chat.title}</b>")
